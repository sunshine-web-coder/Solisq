                ...
                <div className={styles2.m9JKn}>
                    <div className={styles2.details}>
                        ...
                        <div className={styles2.info}>
                            Watch and learn from discussions, courses, DIYs, and contributions from the Solisq core dev. team, Resources, and industry leaders tailored to keep you on track in your development journey. 
                        </div>
                    </div>
                    <div className={styles2.b658}>
                        ...
                        <a href="https://x.com/solisqorg/">Spaces 
