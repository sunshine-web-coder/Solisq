  ...
  return (
    <div className={cn("section", styles2.section)} style={{ paddingTop: 130 }}>
      <div className={cn("container-wide", styles.container)}>
        <h2 className={cn("h2", styles.title)}>Solisq Privacy Policy</h2>
        <div className={styles2.tou}>
          <div className={styles2.inner_tou}>
            <p>
              This Privacy Policy describes how Solisq (hereinafter referred to
              as “we,” “us,” or “our”) might collect, store, share, use, or
              process your information or data when you use Solisq Services
              (collectively referred to as “our Service,” “Services,” or “the
              Service”).
            </p>
            <br />
            ...
            <ul className={styles2.ulist}>
              ...
              <li>
                ...
                <a href="https://solisq.com">https://solisq.com</a>&nbsp; and
                using any of the blockchain features, tools, digital assets,
                white-listed software or program, products, etc., linked to our
                website.
              </li>
              <li>
                Engaging with our ecosystem, including but not limited to our
                community, DAO governance, liquidity pool, mainnet, testnet, or
                any other related ways such as marketing, partnerships, or
                events, etc.
              </li>
            </ul>
            <br />
            <p>
              ...
              including legitimate concerns that affect you when you use Solisq
              Chain Services.
            </p>
            <br />
            <p>
              For further questions or doubts, you can reach us at{" "}
              <a href="mailto:privacy@solisq.com">privacy@solisq.com.</a>
            </p>
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                ...
                you interact with Solisq. You can learn more about this as you
                go down the drain in this Privacy Policy.
              </p>
            </div>
            <div className={styles2.tou_list}>
              <p className={styles2.title}>
              ...
              <p>
                Solisq is a decentralized Web3 service. We do not process
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Solisq does not receive or buy your information from third
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                We process any information you legitimately provide to Solisq
                Chain to provide, improve, and administer Solisq Services,
            ...
            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                5. In what situations and with which entities does Solisq share
            ...
            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                6. How does Solisq protect your information?
              </p>
              <p>
                While it is not ideally possible to completely protect user
                information on any electronic transmission protocol, Solisq
                ...
                information on Solisq.
              </p>
            </div>

            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                7. What are your rights on Solisq?
              </p>
              <p>
                Your privacy rights on Solisq depend on where you are located
                geographically. Applicable privacy laws, which may mean you have
                certain rights regarding your personal information, may vary
                from one geographical location or the other.
              </p>
            </div>

            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                8. Demonstrating your right as a Solisq user
              </p>
              <p>
            ...
            <p>
              ...
              in full to understand your privacy rights as a Solisq.
            </p>
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                ...
                information on our Service; or when you participate in Solisq
              ...
              <ul className={styles2.ulist}>
                ...
                <li>
                  <b>Email addresses.</b> You may provide your email address to
                  us when you sign up for our newsletters, blogs, or email
                  updates.
                </li>
                <li>
                  <b>
                    Details you provide when you register for Solisq Services.
                  </b>{" "}
                  In situations like Solisq clients, validation, DAO governance,
                  and delegation, we may collect information regarding your
                  interest in the protocol. information we may need includes
                </li>
              </ul>
              <ul
              ...
              >
                ...
                <li>
                  ...
                  in our{" "}
                  <a href="https://solisq.gitbook.io/vince-chain-documentation/">
                    documentation.
                  </a>
                </li>
              </ul>
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Solisq does not process sensitive information. We do not accept
                online payments directly on our website &nbsp;
                <a href="https://solisq.com">https://solisq.com.</a>&nbsp;
                ...
                crypto or fiat on or off Solisq, notwithstanding the process
                involved in accessing or using this “Third Party Service,” you
                must understand that you do so at your own risk. You shall bear
                responsibility and liability for adverse concerns from using
                third-party fiat services on Solisq. We advise that you read the
                Privacy Policies of third-party payment services you use on
                Solisq and properly understand them before using their services
                or interacting with them in any possible.
              </p>
            </div>
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Solisq may collect some personal information automatically.
                Information such as your Internet Protocol (IP) address and/or
                browser and device information is collected automatically or
                provided indirectly when you access, use, or visit Solisq
                Services at &nbsp;
                <a href="https://solisq.com">https://solisq.com</a>&nbsp; This
                information we collect does not reveal your specific identity
                ...
                information. Assuredly, we basically need this information to
                maintain the security and operation of our Services and also for
                user improvement programs, internal analytics, and report
                purposes.
              </p>
            </div>
            ...
            <div className={styles2.tou_list}>
              ...
              <div className={styles2.tou_list879}>
                ...
                <p>
                  ...
                  log files when you access or use Solisq Services. Your log
                  data includes but is not limited to your IP address, device
                  ...
                  reports (often called &quot;crash dumps&quot;), and hardware
                  settings).
                </p>
              </div>
              ...
              <div className={styles2.tou_list879}>
                ...
                <p>
                  ...
                  type and settings of the device you use to access Solisq
                  Services. For example, we may use GPS and other technologies
                  on our website &nbsp;
                  <a href="https://solisq.com">https://solisq.com</a>&nbsp; to
                  collect geolocation data that tells us your current location
                  (based on your IP address). You can prevent us from accessing
                  information about your location by disabling your Location
                  setting on your device. However, opting out may prevent you
                  from using certain Solisq Services, which may require your
                  location to be accessed or activated.
                </p>
              </div>
            </div>
            ...
            <div className={styles2.tou_list879}>
              ...
              <div className={styles2.ulist}>
                These reasons may depend on how you interact with Solisq
                Services:
                <ul>
                  <li>
                    <b>
                    ...
                    to your account (on Solisq Services), as well as keep your
                  ...
                  <li>
                    <b>To protect Solisq Services and its users.</b> We may
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Solisq (and Solisq Services) will only process your personal
                information when we deem it necessary and have a legal reason or
                warrant as applicable by law. We, in most cases, require your
                consent to process your personal information. Other legitimate
                reasons may include complying with laws, providing you with
                services to enter into or fulfill our contractual obligations,
                protecting your rights, or fulfilling our legitimate business
                interests.
              </p>
            </div>
            <div className={styles2.tou_list879}>
                    ...
                    <div className={styles2.inner_list}>
                      <ul>
                        ...
                        <li>
                          ...
                          content for Solisq users
                        </li>
                        <li>
                          Diagnose problems and/or prevent fraudulent activities
                        </li>
                        <li>
                          Understand how Solisq users interact with our
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Solisq may share information in certain situations as
              ...
              <div className={styles2.ulist}>
                ...
                <ul>
                  <li>
                    <b>Transfer of business holding or ownership</b> Solisq
                  ...
                  <li>
                    <b>Affiliates.</b> Solisq Services may share your
                  ...
                  <li>
                    <b>Partnerships.</b> Solisq Services may share your
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Due to our decentralized service structure, Solisq or Solisq
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                ...
                Germany. If you are accessing Solisq Services from outside
            ...
            <div className={styles2.tou_list}>
              ...
              <p>
                Solisq employs systemic and secure technical measures to
                ...
                from Solisq Services is at your own risk. We advise that
            ...
            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                9. Policy on Minors That Use Solisq
              </p>
              <p>
                Solisq or Solisq Services does not knowingly collect
                data from minors, nor do we knowingly market our services to
                them. Solisq is only open for access and usage to people
                who are 18 years and above. Minors below the age of 18 or those
                between 13 to 18 years of age shall use Solisq under the
                umbrella of their parent, guardian, or counselor. By using Solisq
            ...
            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                10. What Are Your Solisq Privacy Rights?
              </p>
              <p>
              ...
              <p>
                ...
                <a href="mailto:privacy@solisq.com">
                  privacy@solisq.com.
                </a>{" "}
            ...
            <div className={styles2.tou_list}>
              <p className={styles2.title}>
                8. Other Privacy Rights on Solisq
              </p>
